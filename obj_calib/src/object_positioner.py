...
class meshDisplay():
    ...
    def __init__(self, node_name="obj_calib", topic_name="obj_model_ref", color=(255, 0, 255, 255)):
        self.color = color
        #rate = rospy.Rate(1)
    ...
    def draw_mesh(self, pose, rot=(0.0, 0.0, 0.0, 1.0), color=(0.5, 0.5, 0.5, 1.0), scale=1):
        ...
        self.marker.mesh_resource = "package://obj_calib/meshes/ipad6fix.stl"
